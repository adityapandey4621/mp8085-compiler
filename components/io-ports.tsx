  ...
  return (
    <div className="rounded-lg bg-background border border-border overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-border bg-muted/50">
        ...
        <span className="text-sm font-medium text-foreground">I/O Ports</span>
      </div>
      ...
      <div className="p-4 space-y-2">
        {Object.entries(ports).map(([port, value]) => (
          ...
          >
            <div>
              <div className="text-[10px] text-muted-foreground uppercase tracking-wider">Port</div>
              <div className="font-mono text-sm text-foreground">{port}H</div>
            </div>
